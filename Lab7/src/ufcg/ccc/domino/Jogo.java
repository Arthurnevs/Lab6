...
public class Jogo {
	...
	/**
	 * 
	 * @return Pontos totais na m�o do jogador 1.
	 */
	public int getPontosTotaisJ1() {
		return this.jogador1.getPontosTotais();
	}
	/**
	 * 
	 * @return Pontos totais na m�o do jogador 2.
	 */
	public int getPontosTotaisJ2() {
		return this.jogador2.getPontosTotais();
	}
	/**
	...
	public void rodada() throws EstrategiaInvalidaException, JogadaInvalidaException {
		...
		if (jogadaJ1.getTipo() == TipoJogada.PASSA && jogadaJ2.getTipo() == TipoJogada.PASSA) {
			if(this.getNumPecasJ1() > this.getNumPecasJ2()) {
				...
				this.vencedor = this.jogador2.getNome();
				return;
			}else if(this.getNumPecasJ2() > this.getNumPecasJ1()) {
				this.finalizado = true;
				this.vencedor = this.jogador1.getNome();
				return;
			}else {
				if(this.getPontosTotaisJ1() > this.getPontosTotaisJ2()) {
					this.finalizado = true;
					this.vencedor = this.jogador2.getNome();
				}else if(this.getPontosTotaisJ2() > this.getPontosTotaisJ1()) {
					this.finalizado = true;
					this.vencedor = this.jogador1.getNome();
				}
				else {
