...
public class ControlerFornecedor {
	 ...
	 * @param fornecedor Nome do fornecedor que deseja adicionar o produto.
	 * @param nome Nome do combo
	 * @param descricao Descricao do combo
	 * @param fator Fator de desconto do combo
	 * @param nomeProdutos Nome dos produtos que fazem parte do combo
	 */
	public void adicionaCombo(String fornecedor, String nome, String descricao, double fator, String nomeProdutos) {
		...
		Util.testaNull(nomeProdutos, "Erro no cadastro de combo: combo deve ter produtos.");
		Util.testaVazio(nomeProdutos, "Erro no cadastro de combo: combo deve ter produtos.");
		...
		this.fornecedores.get(fornecedor).adicionaCombo(nome, descricao, fator, nomeProdutos);
	}
	...
	/**
	 * Edita o fator de desconto de um combo de um fornecedor dado o nome do fornecedor, nome
	 * e descricao do porduto e o novo fator de desconto.
	 * @param nome Nome do combo
	 * @param descricao Descricao do combo
	 * @param fornecedor Nome do fornecedor
